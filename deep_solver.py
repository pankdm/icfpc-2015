...
import profile
from magic_land import find_moves_with_magic
...
def search_eval2(tetris, depth):
    ...
    branch_limits = [20, 5, 3, 2, 2, 2, 2]
    #branch_limits = [20, 20, 3, 2, 2, 2, 2]
    #branch_limits = [10, 4, 3, 3, 2, 2, 2]
